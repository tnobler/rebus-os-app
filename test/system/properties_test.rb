...
class PropertiesTest < ApplicationSystemTestCase
  ...
  test "creating a Property" do
    ...
    fill_in "Analysis year", with: @property.analysis_year
    fill_in "Asking price", with: @property.asking_price
    fill_in "Broker", with: @property.broker
    fill_in "City", with: @property.city
    fill_in "Fka", with: @property.fka
    fill_in "Msa", with: @property.msa
    fill_in "Name", with: @property.name
    fill_in "Notes", with: @property.notes
    fill_in "Offer price", with: @property.offer_price
    fill_in "Price per unit", with: @property.price_per_unit
    fill_in "Sales price", with: @property.sales_price
    fill_in "State", with: @property.state
    fill_in "Status", with: @property.status
    fill_in "Street address", with: @property.street_address
    fill_in "Submarket", with: @property.submarket
